...
const eventAliases: Record<string, string[]> = {
  ...
  auto_play_completed: ['auto_play_completed', 'autoplay_completed'],
  auto_play_started: ['auto_play_started', 'autoplay_started'],
  leaderboard_viewed: ['leaderboard_viewed', 'leaderboard_opened'],
  peek_image_clicked: ['peek_image_clicked', 'full_image_peeked', 'peek_image_used'],
  peek_image_used: ['peek_image_used', 'peek_image_clicked', 'full_image_peeked'],
...
export class AdminService {
  ...
  private async getUsageCounts(where: Prisma.AnonymousAnalyticsEventWhereInput) {
    ...
    return {
      ...
      leaderboardViews: sum(['leaderboard_opened', 'leaderboard_viewed']),
      peekImageUsage: sum(['peek_image_clicked', 'peek_image_used', 'full_image_peeked']),
      replayUsage: sum(['auto_play_completed', 'autoplay_completed']),
