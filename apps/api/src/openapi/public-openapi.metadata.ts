...
export const publicApiSchemas = {
  ...
  StreakInfo: {
    additionalProperties: false,
    properties: {
      currentStreak: { minimum: 0, type: 'integer' },
      lastCompletionLocalDate: { nullable: true, type: 'string' },
      lastCompletionTimeZone: { nullable: true, type: 'string' },
      longestStreak: { minimum: 0, type: 'integer' },
      newlyAchievedMilestone: { nullable: true, type: 'integer' },
    },
    required: [
      'currentStreak',
