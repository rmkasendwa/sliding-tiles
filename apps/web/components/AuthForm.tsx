...
export function AuthForm({ mode, oauthError, returnTo }: AuthFormProps) {
  ...
  return (
    ...
    >
      ...
      {oauthError && (
        <p className="rounded-lg border border-danger/30 bg-danger/10 px-3 py-2 text-[0.9rem] text-danger" role="alert">
          {oauthError}
        </p>
      )}
      ...
      >
        <svg aria-hidden="true" className="h-5 w-5" viewBox="0 0 24 24">
          ...
          <path fill="#EA4335" d="M12 6c1.5 0 2.8.5 3.9 1.5l2.9-2.8A9.8 9.8 0 0 0 3.1 7.4l3.4 2.7A5.9 5.9 0 0 1 12 6Z" />
        </svg>
        Continue with Google
      </a>

      <div className="flex items-center gap-3 text-[0.72rem] font-bold uppercase tracking-wider text-muted" aria-hidden="true">
