...
export default function ContactPage() {
  return (
    <section className="page-rail mx-auto grid max-w-300 gap-6 pt-6 pb-12">
      <div className="rounded-xl border border-accent/20 bg-[radial-gradient(circle_at_88%_12%,color-mix(in_srgb,var(--color-accent)_24%,transparent),transparent_34%),radial-gradient(circle_at_12%_100%,color-mix(in_srgb,var(--color-warning)_30%,transparent),transparent_32%),linear-gradient(135deg,color-mix(in_srgb,var(--color-surface)_62%,transparent),color-mix(in_srgb,var(--color-panel)_92%,transparent))] p-5 shadow-panel">
